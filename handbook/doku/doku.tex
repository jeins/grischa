...
GriScha kann als Git-Repository von Grischa-Server bezogen werden. Die aktuelle Version, sowie die Dokumentation unter folgender Adresse zu finden \footnote{Das Passwort gibt es auf Anfrage}:
